...
/**
 * Represents a Snaking-shaped piece in the game. This piece consists of four cells arranged
 * in a configuration resembling a snake, with a curved structure. The specific positions
 * are defined relative to the piece's bounding box.
 *
 ...
 */
public class SnakingPiece extends DDD {

    /**
     * Constructs a Snaking-shaped piece with the given initial position and icons.
     *
    ...
    protected SnakingPiece(Position position, Icon[] icons) {
        ...
        // Initialize the cells that form the Snaking-shaped piece
