...
public class Block {
	...
	public void move(Direction dir) {
		if (dir == UP && orientation == Orientation.VERTICAL) {
			firstRow--;
		} else if (dir == DOWN && orientation == Orientation.VERTICAL) {
			firstRow++;
		} else if (dir == RIGHT && orientation == Orientation.HORIZONTAL) {
			firstCol++;
		} else if (dir == LEFT && orientation == Orientation.HORIZONTAL) {
			firstCol--;
		}
	}
