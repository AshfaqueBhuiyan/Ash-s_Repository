# Muhammad Ashfaque Bhuiyan                                               10-17-2023
# Assignment-4
# This program offers a simplified command-line version of the classic "Connect Four" game that can be played with two players or against a basic computer AI in one-player mode.
...
def printInstructions():
    print("Instructions: This is a simple game where you need to connect four pieces in a row to win.")
...
def getComputerInput(board, currentPlayerTurn):
    ...
    # Check if there is a winning move - if there is, take it
    col = checkForNextMoveWin(board, currentPlayerTurn)

    # Check if the opponent has a winning move - if there is, block it
    if col == -1:
...
def main():
    ...
    while running:
        ...
        if choice == "p":
            ...
            running = False
            print("Hope You Had a Great Time Playing! Goodbye!")
        else:
